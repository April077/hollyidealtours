...
function Info({ img, text, title }: infoType) {
  return (
    <div className="w-full h-auto ">
      <div className="md:flex  p-8  md:p-16">
        ...
        <div className="md:w-2/3 flex flex-col md:justify-center md:items-start justify-center items-center py-5 md:py-0 px-5 ">
